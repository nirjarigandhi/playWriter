...
optimizer = torch.optim.Adam(transformer.parameters(recurse=True), lr=0.00001)
optimizer.zero_grad()
for i in range(200):
    de_in = torch.nn.functional.one_hot(torch.Tensor([start_token]).long(), 10086).unsqueeze(0) * torch.ones((50, 1, 10086))
