...
class DecoderLayer(nn.Module):
    ...
    def __init__(self, encoder_tensor: torch.Tensor, encoder_batch_size: int, encoder_sequence_length: int, encoder_embedding_size: int, input_tensor: torch.Tensor, batch_in: int, sentence_length_in: int, embedding_length_in: int, first_heads: int, reduced_emb_first: int, second_heads: int ,reduced_emb_second: int ,mask=None) -> None:
